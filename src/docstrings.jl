...
julia> write_arrow(df , joinpath(testing_files_path, "test.arrow"));
```
"""
...
julia> read_arrow(joinpath(testing_files_path, "test.arrow"))
2×2 DataFrame
 Row │ AA      AB      
     │ String  Float64 
─────┼─────────────────
...
julia> write_parquet(df, joinpath(testing_files_path, "test.parquet"));
```
"""
...
# Examples
```jldoctest 
julia> read_parquet(joinpath(testing_files_path, "test.parquet"))
2×2 DataFrame
 Row │ AA      AB      
     │ String  Float64 
─────┼─────────────────
